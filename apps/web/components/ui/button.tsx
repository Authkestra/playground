...
// `app/globals.css` (DESIGN.md §7) covers every interactive element, and a
// component that styled its own would eventually drift from it.
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // `primary-accent`, not `primary`: as text on this dark page the surface
        // shade sits at 3.46:1, under AA. See the note in globals.css.
